                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    DayWorkout dayWorkout =
                        DayWorkout(id: 1, day: index + 1, month: "Feb");
...
class ItemFood extends StatefulWidget {
  ...
  const ItemFood({super.key, required this.name, required this.imageUrl, required this.calor, required this.protein, required this.fat, required this.carb, this.isChecked = false});
          ...
          children: [
            Row(
              children: [
                ...
                const Spacer(),
                Icon(
                  isChecked ? Icons.check_circle_outline_outlined : Icons.circle_outlined,
