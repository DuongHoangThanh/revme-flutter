                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(widget.workout!.exercise.imageUrl, scale: 1),
                        fit: BoxFit.cover,
                      ),
                    ),
                    child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    widget.workout!.exercise.durationMinutes.toString() +
                                        ' min',
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  Text(
                                    widget.workout!.exercise.calories.toString() +
                                        ' cal',
                                    style: const TextStyle(
                                      color: Colors.black,
                                      fontWeight: FontWeight.bold,
                              ...
                              Column(
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  Text(
                                    widget.workout!.exercise.sets.toString()+ ' sets',
                                    style: const TextStyle(
                                      color: Colors.black,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 18,
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                viewModel.updateWorkoutStatus(widget.workout!.id, true);
                              });
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => CustomBottomNavigationBar(indexScreen: 1),
                                ),
                              );
                            },
                            child: Container(
